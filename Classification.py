...
from preprocessingUtils import getLesionCoordinates, cropLesion, normalizer
from postTrainingAnalysis import plotROC, getCIAUC

## Data Ingestion and Preprocessing
#Define path for data and csv-file for loading data
path = r'Data'
...
patient_id, sequence_id, ijk_t2w, zone, zone_binary_label = csvLoader(path,csv_file='loadDataList.csv')
...
t2w_cropped = cropLesion(t2w,x_t2w,y_t2w,z_t2w,48,48)

#Normalize cropped ROI patches for training
t2w_norm = normalizer(t2w_cropped)
...
#Testing labels must be encoded in order to accomodate the softmax out
